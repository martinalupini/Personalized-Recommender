...
def main():
    ...
    f.write("1) Pearson correlation between user 1 and 4 (without significance weighting): " + str(round(without_sig,6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    f.write("2) Pearson correlation between user 1 and 4 (with isgnificance weighting): " + str(round(with_sig,6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    f.write("4) Ratio between the two correlations: " + str(round(without_sig/with_sig, 6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    ...
    f.write("7) Weighted average of the deviation from the mean rating for user 1 with item 10: " + str(round(avg_dev, 6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    f.write("8) Rating prediction of item 10 for user 1: " + str(round(score, 6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    ...
    f.write("12) Weighted average of the deviation from the mean rating for user 1 with item 260: " + str(round(avg_dev, 6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
    f.write("13) Rating prediction of item 260 for user 1: " + str(round(score, 6)))
    f.write("\n---------------------------------------------------------------------------------------------------------\n")
